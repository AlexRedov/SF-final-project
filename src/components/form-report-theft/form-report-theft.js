...
export default function FormReportTheft() {
    ...
    return (
        <form className={css.form} onSubmit={handleSubmit}>
            {loading
                ?   <div>
                        <h2 className={css.h2}>Украли...? Скорее заполняйте форму</h2>
                        <div className={css.div_input}>
                            <div className={css.div_input_main}>
                                <label>{THEFT_REPORT_COPY[THEFT_REPORT_TYPES.LICENSENUMBER]}<input name={[THEFT_REPORT_TYPES.LICENSENUMBER]} value={values[THEFT_REPORT_TYPES.LICENSENUMBER]} onChange={handleChange} required/></label>
                                <label>{THEFT_REPORT_COPY[THEFT_REPORT_TYPES.OWNERFULLNAME]}<input name={[THEFT_REPORT_TYPES.OWNERFULLNAME]} value={values[THEFT_REPORT_TYPES.OWNERFULLNAME]} onChange={handleChange} required/></label>
                                ...
                                <label>{THEFT_REPORT_COPY[THEFT_REPORT_TYPES.COLOR]}<input type='text' name={[THEFT_REPORT_TYPES.COLOR]} value={values[THEFT_REPORT_TYPES.COLOR]} onChange={handleChange}/></label>
