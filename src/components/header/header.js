...
export default function Header() {
    ...
    const [badDataMessage, setBadDataMessage] = useState(false)
    ...
    const exit = () => {
        ...
        const result = confirm(`Вы уверенны что хотите выйти?`);
        ...
        <header className={css.header}>
            <div className={css_app.container}>
                ...
                {isFormVisible && !authorization &&(
                    <LoadingContext.Provider value={{imgLoading, setImgLoading, badDataMessage, setBadDataMessage}}>
