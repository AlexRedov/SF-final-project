...
export default function Employees() {
    ...
    const handleClick = (id) => {
        ...
        const result = confirm(`Вы уверены что хотите удалить пользователя?`);
                                ...
                                {dataLoading
                                    ?   <div>
                                            ...
                                            {employees.map( employee => {
                                                return(
                                                    <div className={css.employee} key={employee[RESPONSIBLE_OFFICER_TYPES.ID]}>
                                                        ...
                                                        <button onClick={() => handleClick(employee[RESPONSIBLE_OFFICER_TYPES.ID])}><span>Х</span></button>
                                                    </div>
                                                )
                                            })}
                                            ...
                                            <div className={css.btn_block}>
                                                <button className={css.btn_add} onClick={handleAddNewClick}>
                                                    {isFormVisible ? '-' : '+'}
                                                </button>
                                            </div>
                                        </div>
