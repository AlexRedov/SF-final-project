    ...
    return (
        <div className={css.form_sign}>
            ...
            <form onSubmit={handleSubmit}>
                <label>{RESPONSIBLE_OFFICER_COPY[RESPONSIBLE_OFFICER_TYPES.EMAIL]}<input type='email' value={values[RESPONSIBLE_OFFICER_TYPES.EMAIL]} name={RESPONSIBLE_OFFICER_TYPES.EMAIL} onChange={handleChange} required/></label>
                <label>{RESPONSIBLE_OFFICER_COPY[RESPONSIBLE_OFFICER_TYPES.PASSWORD]}<input type='password' value={values[RESPONSIBLE_OFFICER_TYPES.PASSWORD]} name={RESPONSIBLE_OFFICER_TYPES.PASSWORD} onChange={handleChange} required/></label>
                ...
                <label>{RESPONSIBLE_OFFICER_COPY[RESPONSIBLE_OFFICER_TYPES.CLIENTID]}<input value={values[RESPONSIBLE_OFFICER_TYPES.CLIENTID]} name={RESPONSIBLE_OFFICER_TYPES.CLIENTID} onChange={handleChange} required/></label>
