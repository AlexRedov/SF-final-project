                        ...
                        {dataReceived
                            ?   <div className={css.data_employee}>
                                    ...
                                    <form className={css.editable_data} onSubmit={handleSubmit}>
                                        ...
                                        <label>{RESPONSIBLE_OFFICER_COPY[RESPONSIBLE_OFFICER_TYPES.PASSWORD]}:<input type='password' onChange={handleChange} name={[RESPONSIBLE_OFFICER_TYPES.PASSWORD]} /></label>
